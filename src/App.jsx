...
function App() {
  ...
  return (
    <div className="flex flex-col w-full h-screen items-center items-center sm:justify-center p-4">
      <form onSubmit={handleSubmit} className="fixed bottom-0 w-full flex p-4 sm:relative justify-center">
        ...
        />
        <button type="submit" className="bg-blue-600 p-3 rounded-lg ml-3 text-white font-bold">Search</button>
      </form>
      <Card data={data} />
    </div>
  );
